<?php
class toolsAdminController extends tools {
	function init() {
	}

	function procToolsAdminSetup() {
		...
		$module_info = $oToolsModel->getModulesInfo();
		...
		// module_config에 입력
		$tools->mid = $args->mid;
		$output = $oModuleController->insertModuleConfig('tools', $tools);
