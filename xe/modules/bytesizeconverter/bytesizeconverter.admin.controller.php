<?php
class bytesizeconverterAdminController extends bytesizeconverter {
	function init() {
	}

	function procBytesizeconverterAdminSetup() {
		...
		// 기본설정가져오기
		$oBytesizeconverterModel = &getModel('bytesizeconverter');
		$module_info = $oBytesizeconverterModel->getModulesInfo();
		...
		// module_config에 입력
		$bytesizeconverter->mid = $args->mid;
		$output = $oModuleController->insertModuleConfig('bytesizeconverter', $bytesizeconverter);
