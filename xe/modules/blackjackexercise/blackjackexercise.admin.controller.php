<?php
class blackjackexerciseAdminController extends blackjackexercise {
	function init() {
	}

	function procBlackjackexerciseAdminSetup() {
		...
		// 기본설정가져오기
		$oBlackjackexerciseModel = &getModel('blackjackexercise');
		$module_info = $oBlackjackexerciseModel->getModulesInfo();
		...
		// module_config에 입력
		$blackjackexercise->mid = $args->mid;
		$output = $oModuleController->insertModuleConfig('blackjackexercise', $blackjackexercise);
