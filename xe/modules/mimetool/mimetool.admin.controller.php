<?php
class mimetoolAdminController extends mimetool {
	function init() {
	}

	function procMimetoolAdminSetup() {
		...
		// 기본설정가져오기
		$oMimetoolModel = &getModel('mimetool');
		$module_info = $oMimetoolModel->getModulesInfo();
		...
		// module_config에 입력
		$mimetool->mid = $args->mid;
		$output = $oModuleController->insertModuleConfig('mimetool', $mimetool);
